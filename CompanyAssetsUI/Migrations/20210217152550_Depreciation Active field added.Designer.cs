...
namespace CompanyAssetsUI.Migrations
{
    ...
    [Migration("20210217152550_Depreciation Active field added")]
    partial class DepreciationActivefieldadded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyAssetsUI.Models.Catalogue", b =>
                {
                    ...
                    b.Property<bool>("CatalogueItemActive")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CompanyAssetsUI.Models.Depreciation", b =>
                {
                    ...
                    b.Property<bool>("DepreciationActive")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CompanyAssetsUI.Models.Replacement", b =>
                {
                    b.HasOne("CompanyAssetsUI.Models.Catalogue", "Replaced")
                        .WithMany()
                        .HasForeignKey("CatalogueID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
